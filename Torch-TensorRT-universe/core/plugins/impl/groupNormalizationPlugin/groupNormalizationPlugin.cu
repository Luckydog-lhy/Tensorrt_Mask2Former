...
#include "groupNormalizationKernel.cuh"
using namespace nvinfer1;
//using torch_tensorrt::core::plugins::impl::GroupNormalizationPlugin;
//using torch_tensorrt::core::plugins::impl::GroupNormalizationPluginCreator;
...
namespace
{
   ...
   constexpr const char* GROUP_NORM_NAME{"GroupNormalizationPlugin"};
    constexpr const char* GROUP_NAME_SPACE{"torch_tensorrt"};
} // namespace
...
IPluginV2DynamicExt* GroupNormalizationPlugin::clone() const noexcept
{
    ...
    plugin->setPluginNamespace(GROUP_NAME_SPACE);
    return plugin;
}
...
REGISTER_TORCHTRT_PLUGIN(GroupNormalizationPluginCreator);
} // namespace impl
} // namespace plugins
} // namespace core
} // namespace torch_tensorrt