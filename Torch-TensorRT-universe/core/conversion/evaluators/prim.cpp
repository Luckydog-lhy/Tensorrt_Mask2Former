...
auto prim_registrations =
    RegisterNodeEvaluators()
        ...
        .evaluator({torch::jit::prim::ListUnpack,
                    ...
                    }}).evaluator({torch::jit::prim::ListConstruct,[](const torch::jit::Node* n, kwargs& args) -> c10::optional<torch::jit::IValue> {
                            ...
                            for (auto in : n->inputs()) {
                                if (args.at(in).isITensor()) {
                                    ...
                                    try{
                                        ...
                                        int int_value = args.at(in).unwrapToInt();
                                        at::Tensor value = at::ones(1);
